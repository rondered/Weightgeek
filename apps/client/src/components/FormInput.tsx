...
const InputField = styled.input<{ isInvalid?: boolean }>`
  ${tw`rounded-lg p-3 shadow-sm text-base w-full -ml-10 pl-10 bg-gray-900 placeholder-white transition-colors duration-1000`}
  ${(props) => props.isInvalid && tw`bg-red-800`}
`;
